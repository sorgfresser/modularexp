...
from modularexp.model import check_model_params, build_modules
from modularexp.envs import ENVS, build_env
from modularexp.trainer import Trainer
from modularexp.evaluator import Evaluator
...
def main(params):
    ...
    modularexp.utils.CUDA = not params.cpu
